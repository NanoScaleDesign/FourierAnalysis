...
2. By converting from an exponential-form sum ($\sum_{k=-\infty}^{k=\infty}$) to a trigonometric-form sum ($\sum_{k=1}^{k=\infty}$), re-write the series obtained in challenge \ref{sec:fstexpform} in terms of a trigonometric infinite series (ie, using sines and cosines). To check your answer, evaluate the Fourier series up to $k=2$ with $t=0.8$ and ensure that you get the same answer as you did for challenge \ref{sec:fstexpform}.
