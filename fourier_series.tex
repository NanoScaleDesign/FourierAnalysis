...
256 points: The infinitely repeating square wave where $f(x)=
    \begin{cases}
        1 & \text{for } 0<x<1 \\
        -1 & \text{for } 1<x<2
    \end{cases}$ is an odd function.

512 points: The above infinitely repeating square wave is an even function.

1024 points: The infinitely repeating square wave where $f(x)=
    \begin{cases}
        1 & \text{for } 0<x<2 \\
        0 & \text{for } 2<x<4
    \end{cases}$ is an odd function.

2048 points: The infinitely repeating square wave where $f(x)=
    \begin{cases}
        1 & \text{for } 0<x<2 \\
        0 & \text{for } 2<x<4
    \end{cases}$ is an even function.
...
\begin{enumerate}
    ...
    \item Square wave function $f(t) = \begin{cases} 2 & \text{for } 0<x<1 \\ 1 & \text{for } 1<x<2 \end{cases}$
...
% NT: Add practise of e^2pi i k = 1 before this challenge.
% NT: Change to saw-wave
...
\vspace{1em}
3. Referring to the resource, do sharp corners in a function lead to higher or lower frequencies? % NT: Understanding why this is true confuses some people. Add an explanation.

\vspace{1em}
4. Does non-periodiciy lead to higher or lower frequencies? In challenge \ref{sec:fstexpform} you calculated the Fourier series for $f(t)=t$. If the series is written in a form similar to equation \ref{eq:sinxform}, what would $N$ be in this case? % NT: This is difficult and badly worded because explaining how f(t)=t leads to high frequencies in an intuetive fashion is difficult. Do the proper definition in terms of infinitely differentiable functions.
