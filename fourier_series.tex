...
% NT: Need to explain about re-arranging. Otherwise students try to use formula instead. Need practise about switching from sums from -infty to sums from 1
...
\subsection*{Challenge}
1. The Fourier series is a sum to $\pm \infty$, however in some cases the coefficients ($C_k$'s) are zero beyond a certain number of terms. Which of the terms below will have Fourier coefficients that are all zero after a certain number of terms? Sum the points of these functions.
...
\vspace{1em}
2. Briefly explain the characteristics of functions that lead to infinite Fourier series and finite Fourier series.
