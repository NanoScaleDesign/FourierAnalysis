...
In order to prove to outside parties that you have learned something from the course, we must perform summative assessments. This will be in the form of a mid-term exam (weighted 40\%), a satisfactory challenge-log (weighted 10\%) and a final exam (weighted 50\%).
