...
\begin{itemize}
    ...
    \item $P$ = participation calculated as $P = (F/N)(A/N) (0.5 + L/2)$ where each terms is as follows
        \begin{itemize}
            ...
            \item $L$ = Proportion (decimal from 0 to 1) of the number of times that a collected challenge log is satisfactory (this means: available on request, your calculations are clearly shown, it corresponds to your spreadsheet, and it covers all challenges up to at least the minimum challenge for that week).
        \end{itemize}
\end{itemize}
