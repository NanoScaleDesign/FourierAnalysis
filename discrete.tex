...
You will need to unzip the kyudai.png file before use.
...
\begin{itemize}
    ...
    \item Kyudai image: \url{http://raw.githubusercontent.com/NanoScaleDesign/FourierAnalysis/master/image_processing/kyudai.png.zip}
\end{itemize}
