...
16 points: $\displaystyle \mathcal{F}f(w)=\int_{-\infty}^{\infty} e^{i 2 \pi w t} f(t) dt$ % Technically an inverse FT, but does not correspond to 'a' and 'b' values in the table so is invalid.
